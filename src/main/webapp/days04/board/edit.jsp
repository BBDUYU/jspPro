...
<title>2025. 12. 11. 오후 2:50:33</title>
...
<div>
  <xmp class="code"> 
  	edit.jsp
  	각 입력태그의 name속성은 오라클의 테이블의 컬럼명과 동일
  </xmp>
  <form method="post">
   <table>
      <tr>
      ...
      <tr>
         ...
         <td><input type="text" name="writer" size="15" disabled="disabled"
         value="${dto.writer}"></td>
      </tr>
      <tr>
      ...
      <tr>
         <td colspan="2" align="center">
            ...
            <a href="javascript:hitsory.back();">이전</a></td>
      </tr>
   </table>
</form>
</div>
