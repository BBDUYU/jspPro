    ...
    <tfoot>
      <tr>
        <td colspan="4" align="center">
          <a href="<%= contextPath %>/cstvsboard/edit.htm?seq=${dto.seq}&currentPage=${param.currentPage}&numberPerPage=${param.numberPerPage}&searchCondition=${param.searchCondition}&searchWord=${param.searchWord}">수정하기</a>
          <a href="<%= contextPath %>/cstvsboard/delete.htm?seq=${dto.seq}&currentPage=${param.currentPage}&numberPerPage=${param.numberPerPage}&searchCondition=${param.searchCondition}&searchWord=${param.searchWord}">삭제하기</a>
          <a href="<%= contextPath %>/cstvsboard/list.htm?currentPage=${param.currentPage}&numberPerPage=${param.numberPerPage}&searchCondition=${param.searchCondition}&searchWord=${param.searchWord}">Home</a>
          <!-- jquery.com 모달창 삭제 -->
