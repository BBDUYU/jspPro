...
<title>2026. 1. 5. 오전 10:11:30</title>
      ...
      <tr>
         <td colspan="2" align="center">
           <input type="button" value="글수정"
            onclick="location.href='edit.htm?num=${ dto.num }&page=${ param.page}&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">

            <a href="delete.htm?num=${ dto.num }">글삭제</a> 
             
           <!-- [기억] 답글 버튼 클릭하면           write.do?부모num, 부모그룹 ref, 부모step,부모=depth -->
            <input type="button" value="답글"
            onclick="location.href='write.htm?num=${ dto.num }&ref=${dto.ref }&step=${ dto.step }&depth=${ dto.depth }'">
         
         <input type="button" value="글목록"
            onclick="location.href='list.htm?page=${ param.page}&searchCondition=${ param.searchCondition }&searchWord=${ param.searchWord }'">
         </td>
      </tr>
      <tr>
         <td colspan="2" align="center">
