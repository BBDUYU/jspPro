...
import days07.mvc.domain.BoardDTO;
...
public interface BoardDAO {
	...
	// 4-2. 삭제할 게시글의 실제 비밀번호를 반환하는 추상메서드 선언
	...
	// 6-2. 페이징 처리 O
	List<BoardDTO> search(String condition, String keyword
	...
	int getTotalPages(int numberPerPage
			, String condition, String keyword) throws SQLException;;
